...
export const messages = {
  zh: {
    ...
    memberUnsure: "不确定",
    memberToday: "今日",
    progressExplanation: "成员数据按提交的审核尝试计数；整体数据描述当前有效数据集。管理员重新开放后，两者合计可能不同。",
  ...
  en: {
    ...
    memberUnsure: "Unsure",
    memberToday: "Today",
    progressExplanation: "Member totals count submitted review attempts; overall totals describe the current active dataset. Sums may differ after an admin reopens an item.",
